...
export default function Home() {
  ...
  supabase.auth.onAuthStateChange((_event, session) => {
    ...
    async function updateUser() {
        const { data, error } = await supabase.auth.updateUser({email: 'joel+anotheremail@supabase.com'}, {redirectTo: 'https://www.google.com'})
    }
    ...
    async function oidcSignIn() {
        ...
        const { data, error } = await supabase.auth.signInWithIdToken({
            provider: 'google',
            token:'eyJhbGciOiJSUzI1NiIsImtpZCI6IjJkOWE1ZWY1YjEyNjIzYzkxNjcxYTcwOTNjYjMyMzMzM2NkMDdkMDkiLCJ0eXAiOiJKV1QifQ..E9dhIZjBY4_4TePAQyqdpLxh9WNAqrAJPZAGg2RD6SSQyBMw0bDeHSAVdwZf9xxrjtug_O3-FyJylopBFalvmhx9_bY_2b0SYI9AvbhpZ0N8Xid3yUN2JFY1IalDw67xkKKqmKnzkQshcS6AGQ7GclQdNIqwBJOyUhol_kHQyBHUE8JEuLIF3kjZn2ouN-64M53-bNPgBfrMX0QA2y5TM1YlpThsWwKR32e3BK-9EDCK_EnStEfq9nZWkOFAbgaEkhLEuoRLRsF2klLDANcQmIQxb9nOBJGfVfJrEfS2Ro7Dlbfpp0wo_FaQh-Ymf_cco_7RTNns-8fkD8UROA5gqw'
        })
        console.log(data)
        console.log(error)
